...
import { removeProduct, clearAll } from "../redux/slices/estimationSlice";
    ...
    <>
      ...
      <div className="w-[90%] mx-auto px-30 flex flex-col justify-between">
        <div className="relative px-20 py-10 flex justify-center items-center">
          ...
          <button
            className="text-xl absolute right-20 bg-custom-yellow px-4 py-2 rounded font-medium"
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="bg-custom-yellow px-4 py-2 rounded font-medium mt-2 w-fit"
                >
                  Remove
                </button>
              </div>
